...
df_grountruth_score_update.index = [i+'_'+j+'_'+k for i,j,k in zip(df_grountruth_score['Drug1_PC3'].values, 
                                                            df_grountruth_score['Drug2_PC3'].values, 
                                                            df_grountruth_score['Cell_line'].values) ]
...
# only keep the drugs not in the pre-trained datasets for testing.
test_list = []
final_index = []
