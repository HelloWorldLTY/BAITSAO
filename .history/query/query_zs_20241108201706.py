...
# checkpoint = torch.load("/gpfs/gibbs/pi/zhao/tl688/DeepSynergy/epoch=103-step=60944zip_update100.ckpt")
# model.load_state_dict(checkpoint["state_dict"])

# checkpoint = torch.load("/gpfs/gibbs/pi/zhao/tl688/DeepSynergy/cv_example/epoch=101-step=14994.ckpt")
# model.load_state_dict(checkpoint["state_dict"])
...
# model.encoder.loewe = nn.Linear(layers[1], layers[2])
# model.encoder.loewe_input = nn.Linear(n_dim*2 + drug_num_dim, layers[1])
